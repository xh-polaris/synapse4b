...
type BasicUser struct {
	...
	UnitID    *id.ID         `gorm:"column:unit_id;type:binary(12);index:uk_unit_code,unique;index:uk_unit_phone,unique;index:uk_unit_email,unique" json:"unit_id"` // UnitID 学校ID
	Code      *string        `gorm:"column:code;type:varchar(24);index:uk_unit_code,unique" json:"code"`                                                            // Code 学号
	Phone     *string        `gorm:"column:phone;type:varchar(16);index:uk_unit_phone,unique" json:"phone"`                                                         // Phone 手机号
	Email     *string        `gorm:"column:email;type:varchar(191);index:uk_unit_email,unique" json:"email"`                                                        // Email 邮箱
