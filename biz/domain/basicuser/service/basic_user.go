...
type BasicUser interface {
	...
	CodeExist(ctx context.Context, unitId, code string) (is bool, err error)
	EmailExist(ctx context.Context, email string) (is bool, err error)
	LoginByPhone(ctx context.Context, requirePassword bool, phone, verify string, unitId string) (*entity.BasicUser, error)
	LoginByEmail(ctx context.Context, requirePassword bool, email, verify string, unitId string) (*entity.BasicUser, error)
